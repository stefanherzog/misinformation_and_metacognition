...
fig_dem_rep_d1 <- df_dem_rep %>%
  ...
  scale_color_manual(
    values = c(
      "all" = "black",
      "congruent (party)" = "#32CD32",
      "incongruent (party)" = "red",
      "neutral (party)" = "#666666"
    )
  ) +
  scale_shape_manual(
    values = c(
  ...
  labs(x = "", y = expression(italic("d'")), shape = "Statements") +
...
fig_dem_rep_meta_d1 <- df_dem_rep %>%
  ...
  labs(x = "", y = expression(italic("meta-d'")), shape = "Statements") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_minimal_hgrid() +
  labs(color = "Statements")
fig_dem_rep_meta_d1
...
fig_dem_rep_mratio <- df_dem_rep %>%
  ...
  labs(x = "", y = expression(italic("Mratio")), shape = "Statements") +
  theme_minimal_hgrid() +
  labs(color = "Statements")
fig_dem_rep_mratio
...
fig_dem_rep_mdiff <- df_dem_rep %>%
  ...
  labs(x = "", y = expression(italic("Mdiff")), shape = "Statements") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_minimal_hgrid() +
  labs(color = "Statements")
fig_dem_rep_mdiff
...
fig_dem_rep_truth_d1 <- df_dem_rep %>%
  ...
  scale_color_manual(
    values = c(
      "all" = "black",
      "congruent (party*truth)" = "#32CD32",
      "incongruent (party*truth)" = "red",
      "neutral (party*truth)" = "#666666"
    )
  ) +
  scale_shape_manual(
    values = c(
...
fig_lib_con_d1 <- df_lib_con %>%
  ...
  scale_color_manual(
    values = c(
      "all" = "black",
      "congruent (ideology)" = "#32CD32",
      "incongruent (ideology)" = "red",
      "neutral (ideology)" = "#666666"
    )
  ) +
  scale_shape_manual(
    values = c(
...
fig_lib_con_truth_d1 <- df_lib_con %>%
  ...
  scale_color_manual(
    values = c(
      "all" = "black",
      "congruent (ideology*truth)" = "#32CD32",
      "incongruent (ideology*truth)" = "red",
      "neutral (ideology*truth)" = "#666666"
    )
  ) +
  scale_shape_manual(
    values = c(
